...
# Else the default is to use an embedded sqlite file (autogenerated)
# The information for this database is defined under .\yugisearcher\yugisearcher\settings.py
# See the github page at https://github.com/xion1358/seis630-yugisearcher for more help
...
def check_server_ready(url="http://127.0.0.1:8000/", timeout=300):
